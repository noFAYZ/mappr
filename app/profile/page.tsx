...
export default function SettingsPage() {
  ...
  const { isSidebarCollapsed, setSidebarCollapsed } = useNavigationContext();
  const {
    compactMode,
    setCompactMode,
    addNotification,
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-sm text-default-500">
                        Reduce spacing throughout interface
                      </p>
                    </div>
                    <Switch
                      color="primary"
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-default-600 mt-1">
                        Press{" "}
                        <kbd className="px-1 py-0.5 bg-default-100 rounded text-xs">
                          ⌘+D
                        </kbd>{" "}
                        to toggle theme
                      </p>
          ...
          title={
            <div className="flex items-center gap-2">
              ...
              {getNotificationStats().unread > 0 && (
                <Badge
                  color="danger"
                  content={getNotificationStats().unread}
                  size="sm"
                />
              )}
            </div>
          ...
          <Card>
            <CardHeader>
              <div>
                ...
                <p className="text-sm text-default-500">
                  {getNotificationStats().total} total,{" "}
                  {getNotificationStats().unread} unread
                </p>
              </div>
            </CardHeader>
            <CardBody className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                >
                  Clear Read (
                  {getNotificationStats().total - getNotificationStats().unread}
                  )
                </Button>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-success-600 mt-1">
                      Notification system is operational. Manage notifications
                      via navbar dropdown.
                    </p>
                  </div>
                </div>
