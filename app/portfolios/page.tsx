...
export default function PortfoliosPage() {
  ...
  const averageChange = portfolios.reduce((sum, portfolio) => sum + portfolio.change24h, 0) / portfolios.length;
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <CardBody className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <div className={`flex items-center gap-1 mt-1 ${getChangeColor(averageChange)}`}>
        ...
        <Card>
          <CardBody className="p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-default-500 font-medium">Active Portfolios</p>
        ...
        <Card>
          <CardBody className="p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-default-500 font-medium">Total Items</p>
                <p className="text-2xl font-bold">
                  {portfolios.reduce((sum, p) => sum + p.itemCount, 0)}
                </p>
                <p className="text-xs text-default-400 mt-1">Connected sources</p>
              </div>
        ...
        <Card>
          <CardBody className="p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-default-500 font-medium">Performance</p>
              ...
              <div className="flex items-center justify-between w-full">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-default-500">{portfolio.itemCount} items</p>
                  </div>
                </div>
              ...
              <div className="space-y-4">
                ...
                <div>
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <div className={`flex items-center gap-1 ${getChangeColor(portfolio.change24h)}`}>
                  ...
                  <p className="text-sm text-default-600 mb-3">{portfolio.description}</p>
                  ...
                  <div className="grid grid-cols-3 gap-3 text-center">
                    <div>
                      ...
                      <p className={`text-sm font-medium ${getChangeColor(portfolio.change24h)}`}>
                        {portfolio.change24h >= 0 ? '+' : ''}{portfolio.change24h.toFixed(2)}%
                      </p>
                    </div>
                    <div>
                      <p className="text-xs text-default-500">7d</p>
                      <p className={`text-sm font-medium ${getChangeColor(portfolio.change7d)}`}>
                        {portfolio.change7d >= 0 ? '+' : ''}{portfolio.change7d.toFixed(2)}%
                      </p>
                    </div>
                    <div>
                      <p className="text-xs text-default-500">30d</p>
                      <p className={`text-sm font-medium ${getChangeColor(portfolio.change30d)}`}>
                        {portfolio.change30d >= 0 ? '+' : ''}{portfolio.change30d.toFixed(2)}%
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="text-center py-4">
                ...
                <div className="bg-warning-50 border border-warning-200 rounded-lg p-3">
                  <p className="text-warning-800 text-sm">
                    All portfolio items and historical data will be permanently removed.
                  </p>
                </div>
              </div>
            ) : (
