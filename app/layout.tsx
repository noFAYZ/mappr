...
function LayoutContent({ children }: LayoutContentProps) {
  ...
  const shouldHideSidebar = NO_SIDEBAR_PAGES.some(page => 
  ...
  const isOnboardingPage = ONBOARDING_PAGES.some(page => 
    pathname === page || pathname.startsWith(page + '/')
  );
    ...
    return (
      <div className="min-h-screen bg-background">
        ...
        <div className="relative z-10">
          ...
          <Navbar 
            className="bg-background/80 backdrop-blur-xl border-b border-default-200/50 shadow-sm"
