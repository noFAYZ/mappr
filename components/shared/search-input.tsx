  ...
  return (
    <>
      ...
      <Modal
        ...
        classNames={{
          backdrop:
            "bg-gradient-to-br from-background/40 via-background/60 to-background/40 backdrop-blur-md",
          base: "border border-default-200/50 shadow-2xl bg-background/95 backdrop-blur-xl",
          header:
            "border-b border-default-200/50 bg-gradient-to-r from-default-50/50 to-default-100/30",
                ...
                <div className="bg-gradient-to-r from-default-50 to-primary-50/30 rounded-lg p-4 border border-default-200/50">
                  ...
                  <div className="text-xs text-default-600 space-y-1">
                    <p>
                      • Use{" "}
                      <Kbd
                        className="bg-default-200 text-xs mx-1"
                        keys={["command"]}
                      >
                        K
                      </Kbd>{" "}
                    ...
                    <p>
                      • Try searching for "portfolio", "wallet", "analytics"
                    </p>
