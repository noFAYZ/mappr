...
export function SolarWalletOutline(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      ...
      {...props}
    >
      <path d="M19 12a1 1 0 1 1-2 0a1 1 0 0 1 2 0" fill="currentColor" />
      <path
        clipRule="evenodd"
  ...
  return (
    ...
    >
      ...
      >
        ...
        <path d="M8.5 10a1.5 1.5 0 1 1 0-3a1.5 1.5 0 0 1 0 3m7 7a1.5 1.5 0 1 0 0-3a1.5 1.5 0 0 0 0 3M10 8.5h7m-3 7H7" />
      </g>
    </svg>
  );
}
  ...
  return (
    ...
    >
      <g fill="none" stroke="currentColor" strokeWidth={4}>
        ...
        <path d="M31 18v-7a7 7 0 1 0-14 0v7" strokeLinejoin="round" />
        <path d="M24 26v8" strokeLinecap="round" strokeLinejoin="round" />
      </g>
    </svg>
  );
}
...
export function BasilWalletOutline(props: SVGProps<SVGSVGElement>) {
  return (
    ...
    >
      <path
        d="M15.5 12a1.5 1.5 0 1 1 3 0a1.5 1.5 0 0 1-3 0"
        fill="currentColor"
        stroke="currentColor"
        strokeWidth={0.5}
      />
...
export default function ProiconsArrowTrending(props: SVGProps<SVGSVGElement>) {
  return (
    ...
    >
      <path
        d="m3.25 16.75l4.793-4.793a1 1 0 0 1 1.414 0l2.586 2.586a1 1 0 0 0 1.414 0L19.75 8.25l.56-.56m-5.56-.44h4.5c.414 0 .79.168 1.06.44m.44 5.56v-4.5c0-.414-.168-.79-.44-1.06"
        fill="none"
        stroke="currentColor"
        strokeLinecap="round"
        strokeLinejoin="round"
  ...
  return (
    ...
    >
      <g
        ...
        strokeWidth={0.5}
      >
        <path d="M17.906 17.231c.393.45 1.093.458 1.438-.028a9 9 0 0 0 1.562-6.503c-.086-.59-.714-.9-1.268-.678l-4.645 1.858a1 1 0 0 0-.38 1.587zM19.346 6.8c.344.487.103 1.144-.45 1.366l-4.525 1.81A1 1 0 0 1 13 9.044V4.175c0-.597.52-1.065 1.1-.925a9 9 0 0 1 5.245 3.55" />
        <path d="M11 3.156c0-.592-.513-1.059-1.092-.935a10 10 0 1 0 6.957 18.516c.517-.288.596-.977.207-1.422L11.285 12.7a1.15 1.15 0 0 1-.285-.757z" />
      </g>
    </svg>
  );
}
...
export function MynauiArrowUpDownSolid(props: SVGProps<SVGSVGElement>) {
  return (
    ...
    >
      <path
        d="M7.5 18.25a.75.75 0 0 0 .75-.75v-6.97h3.28a.75.75 0 0 0 0-1.06l-3.5-3.5a.75.75 0 0 0-1.06 0l-3.5 3.5a.75.75 0 0 0 0 1.06h3.28v6.97c0 .414.336.75.75.75m9-12.5a.75.75 0 0 1 .75.75v6.97h3.28a.75.75 0 0 1 0 1.06l-3.5 3.5a.75.75 0 0 1-1.06 0l-3.5-3.5a.75.75 0 0 1 0-1.06h3.28V6.5a.75.75 0 0 1 .75-.75"
        fill="currentColor"
        stroke="currentColor"
        strokeWidth={0.5}
      />
...
export function SolarDollarMinimalisticBoldDuotone(
...
export function TablerLayoutSidebarLeftCollapse(
  props: SVGProps<SVGSVGElement>,
) {
  return (
    <svg
...
export function SystemUiconsWindowCollapseRight(
  props: SVGProps<SVGSVGElement>,
) {
  return (
    <svg
    ...
    >
      ...
      >
        ...
        <path
          ...
          fill="currentColor"
        />
        <path d="m10.5 13.5l-3-3l3-3m5 3h-8" />
      </g>
    </svg>
  );
}
    ...
    >
      <g fill="none">
        ...
        <path
          ...
          strokeWidth={1}
        />
        <circle cx={12} cy={15} fill="currentColor" r={2} />
        <path
          d="M12 16v2.5"
          stroke="currentColor"
          strokeLinecap="round"
...
export function BitcoinIconsCaretUpFilled(props: SVGProps<SVGSVGElement>) {
  return (
    ...
    >
      <path
        clipRule="evenodd"
        d="M12.248 8.237a.25.25 0 0 0-.354 0L5.53 14.601a.75.75 0 1 1-1.06-1.06l6.363-6.364a1.75 1.75 0 0 1 2.475 0l6.364 6.364a.75.75 0 0 1-1.06 1.06z"
        fill="currentColor"
        fillRule="evenodd"
        stroke="currentColor"
        strokeWidth={0.5}
...
export function ArcticonsEssentialSpace(props: SVGProps<SVGSVGElement>) {
  return (
    ...
    >
      ...
      />
      <path
        d="m21 3.305l-13.424 7.75a6 6 0 0 0-3 5.195v15.5a6 6 0 0 0 3 5.195L21 44.695a6 6 0 0 0 6 0l13.424-7.75a6 6 0 0 0 3-5.195v-15.5a6 6 0 0 0-3-5.195L27 3.305a6 6 0 0 0-6 0m3 12.123V8.5m0 31v-6.928m7.424-12.857l6-3.464m-26.847 15.5l6-3.464m-.001-8.571l-6-3.464m26.847 15.5l-6-3.464"
        fill="none"
        stroke="currentColor"
        strokeLinecap="round"
        strokeLinejoin="round"
...
export function RiSpaceShipFill(props: SVGProps<SVGSVGElement>) {
  return (
    ...
    >
      <path
        d="M2.88 18.049a35.9 35.9 0 0 1 8.531-16.32a.8.8 0 0 1 1.178 0q.25.27.412.456a35.9 35.9 0 0 1 8.119 15.864a44 44 0 0 1-6.584.875L12.447 23.1a.5.5 0 0 1-.894 0l-2.089-4.177a44 44 0 0 1-6.584-.875M12 14.995a3 3 0 1 0 0-6a3 3 0 0 0 0 6"
        fill="currentColor"
        stroke="currentColor"
        strokeWidth={0.5}
      />
...
export function MdiSpaceInvaders(props: SVGProps<SVGSVGElement>) {
  return (
    ...
    >
      <path
        d="M7 6H5V4h2zm10 0h2V4h-2zm6 6v6h-2v-4h-2v4h-2v-2H7v2H5v-4H3v4H1v-6h2v-2h2V8h2V6h2v2h6V6h2v2h2v2h2v2zm-8-2v2h2v-2zm-8 2h2v-2H7zm4 6H7v2h4zm6 0h-4v2h4z"
        fill="currentColor"
        stroke="currentColor"
        strokeWidth={0.5}
      />
...
export function MdiMessageFastOutline(props: SVGProps<SVGSVGElement>) {
  return (
    ...
    >
      <path
        d="M20 5H9c-1.1 0-2 .9-2 2v14l4-4h9c1.1 0 2-.9 2-2V7c0-1.1-.9-2-2-2m0 10h-9.8L9 16.2V7h11zM3 7c-.6 0-1 .4-1 1s.4 1 1 1h2V7zm-1 4c-.6 0-1 .4-1 1s.4 1 1 1h3v-2zm-1 4c-.6 0-1 .4-1 1s.4 1 1 1h4v-2z"
        fill="currentColor"
        stroke="currentColor"
        strokeWidth={0.5}
      />
  ...
  return (
    ...
    >
      <path
        ...
        d="m12.67 2.217l8.5 4.75A1.5 1.5 0 0 1 22 8.31v1.44c0 .69-.56 1.25-1.25 1.25H20v8h1a1 1 0 1 1 0 2H3a1 1 0 1 1 0-2h1v-8h-.75C2.56 11 2 10.44 2 9.75V8.31c0-.522.27-1.002.706-1.274l8.623-4.819c.422-.211.92-.211 1.342 0z"
        fill="currentColor"
        fillRule="evenodd"
        opacity={0.3}
        stroke="currentColor"
      ...
      <path
        ...
        d="M12 6a1 1 0 1 0 0 2a1 1 0 0 0 0-2m5 5H7v8h2v-6h2v6h2v-6h2v6h2z"
        fill="currentColor"
        fillRule="evenodd"
        stroke="currentColor"
        strokeWidth={0.5}
...
export function FluentCubeSync20Regular(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      height={20}
      viewBox="0 0 20 20"
    ...
    >
      <path
        d="M5.703 6.042a.5.5 0 1 0-.406.914L9.5 8.824v3.382a5.5 5.5 0 0 1 1-1.481v-1.9l4.203-1.869a.5.5 0 1 0-.406-.914L10 7.952zM9.072 16.59q.191.075.39.12q.25.565.614 1.057a3.5 3.5 0 0 1-1.376-.25l-5.757-2.302A1.5 1.5 0 0 1 2 13.822V6.176a1.5 1.5 0 0 1 .943-1.392L8.7 2.48a3.5 3.5 0 0 1 2.6 0l5.757 2.303c.57.227.943.779.943 1.392v4.08a5.5 5.5 0 0 0-1-.657V6.176a.5.5 0 0 0-.314-.464L10.929 3.41a2.5 2.5 0 0 0-1.857 0L3.314 5.712A.5.5 0 0 0 3 6.176v7.646a.5.5 0 0 0 .314.465zM10 14.5a4.5 4.5 0 1 0 9 0a4.5 4.5 0 0 0-9 0m6.5-3a.5.5 0 0 1 .5.5v1.5a.5.5 0 0 1-.5.5H15a.5.5 0 1 1 0-1h.468a2 2 0 0 0-1.717-.105a2 2 0 0 0-.665.44a.5.5 0 1 1-.707-.707A3 3 0 0 1 16 12.152V12a.5.5 0 0 1 .5-.5m-.876 5.531A3 3 0 0 1 13 16.848V17a.5.5 0 1 1-1 0v-1.5a.5.5 0 0 1 .5-.5H14a.5.5 0 0 1 0 1h-.468q.075.04.155.077a2 2 0 0 0 2.227-.413a.5.5 0 0 1 .707.707a3 3 0 0 1-.997.66"
        fill="currentColor"
        stroke="currentColor"
        strokeWidth={0.5}
      />
...
export function StreamlineFreehandHierarchyWeb(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      height={24}
      viewBox="0 0 24 24"
...
export function FamiconsReturnUpBack(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      height={512}
      viewBox="0 0 512 512"
