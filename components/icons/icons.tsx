...
export function IconParkOutlineLockOne(props: SVGProps<SVGSVGElement>) {
	return (<svg xmlns="http://www.w3.org/2000/svg" width={48} height={48} viewBox="0 0 48 48" {...props}><g fill="none" stroke="currentColor" strokeWidth={4}><circle cx={24} cy={30} r={14}></circle><path strokeLinejoin="round" d="M31 18v-7a7 7 0 1 0-14 0v7"></path><path strokeLinecap="round" strokeLinejoin="round" d="M24 26v8"></path></g></svg>);
}


export function BasilWalletOutline(props: SVGProps<SVGSVGElement>) {
	return (<svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" {...props}><path fill="currentColor" d="M15.5 12a1.5 1.5 0 1 1 3 0a1.5 1.5 0 0 1-3 0" strokeWidth={0.5} stroke="currentColor"></path><path fill="currentColor" fillRule="evenodd" d="M20.441 6.674a4.71 4.71 0 0 0-3.84-2.839l-.652-.068a44.4 44.4 0 0 0-9.9.068l-.432.051a3.68 3.68 0 0 0-3.214 3.169a37.4 37.4 0 0 0 0 9.89a3.68 3.68 0 0 0 3.214 3.169l.432.051c3.287.392 6.607.415 9.9.068l.652-.068a4.71 4.71 0 0 0 3.84-2.839a2.77 2.77 0 0 0 1.963-2.324c.233-1.994.233-4.01 0-6.004a2.77 2.77 0 0 0-1.963-2.324m-4.65-1.416a43 43 0 0 0-9.565.066l-.432.052A2.18 2.18 0 0 0 3.89 7.253a36 36 0 0 0 0 9.494a2.18 2.18 0 0 0 1.904 1.877l.432.052c3.176.378 6.385.4 9.566.066l.652-.069a3.2 3.2 0 0 0 2.124-1.131a27 27 0 0 1-4.526-.118a2.77 2.77 0 0 1-2.446-2.422a26 26 0 0 1 0-6.004a2.77 2.77 0 0 1 2.446-2.422a27 27 0 0 1 4.526-.118a3.2 3.2 0 0 0-2.124-1.131zm3.486 2.757l.002.011l.006.04l.199-.032q.154.015.308.033c.587.065 1.055.53 1.122 1.105c.22 1.879.22 3.777 0 5.656a1.27 1.27 0 0 1-1.122 1.105q-.154.018-.308.033l-.199-.031l-.006.039l-.002.011c-1.678.152-3.4.135-5.069-.052a1.27 1.27 0 0 1-1.122-1.105a24.3 24.3 0 0 1 0-5.656a1.27 1.27 0 0 1 1.122-1.105a25.4 25.4 0 0 1 5.07-.052" clipRule="evenodd" strokeWidth={0.5} stroke="currentColor"></path></svg>);
}

export function SolarBillListBold(props: SVGProps<SVGSVGElement>) {
	return (<svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" {...props}><path fill="currentColor" fillRule="evenodd" d="M7.245 2h9.51c1.159 0 1.738 0 2.206.163a3.05 3.05 0 0 1 1.881 1.936C21 4.581 21 5.177 21 6.37v14.004c0 .858-.985 1.314-1.608.744a.946.946 0 0 0-1.284 0l-.483.442a1.657 1.657 0 0 1-2.25 0a1.657 1.657 0 0 0-2.25 0a1.657 1.657 0 0 1-2.25 0a1.657 1.657 0 0 0-2.25 0a1.657 1.657 0 0 1-2.25 0l-.483-.442a.946.946 0 0 0-1.284 0c-.623.57-1.608.114-1.608-.744V6.37c0-1.193 0-1.79.158-2.27c.3-.913.995-1.629 1.881-1.937C5.507 2 6.086 2 7.245 2M7 6.75a.75.75 0 0 0 0 1.5h.5a.75.75 0 0 0 0-1.5zm3.5 0a.75.75 0 0 0 0 1.5H17a.75.75 0 0 0 0-1.5zM7 10.25a.75.75 0 0 0 0 1.5h.5a.75.75 0 0 0 0-1.5zm3.5 0a.75.75 0 0 0 0 1.5H17a.75.75 0 0 0 0-1.5zM7 13.75a.75.75 0 0 0 0 1.5h.5a.75.75 0 0 0 0-1.5zm3.5 0a.75.75 0 0 0 0 1.5H17a.75.75 0 0 0 0-1.5z" clipRule="evenodd" strokeWidth={0.5} stroke="currentColor"></path></svg>);
}


export function StashImageOpen(props: SVGProps<SVGSVGElement>) {
	return (<svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" {...props}><path fill="currentColor" d="M15.65 9.37a2.6 2.6 0 0 1 1.561 0c.336.107.613.294.876.515c.251.21.534.49.868.82l1.18 1.165l.029.03c.114.112.25.245.35.407c.088.14.153.296.193.458c.045.187.044.376.043.532v.04c-.006 1.38-.034 2.372-.47 3.189a4.2 4.2 0 0 1-1.867 1.784c-.495.24-1.034.343-1.662.392c-.615.048-1.376.048-2.331.048h-2.87c-.956 0-1.717 0-2.33-.048c-.63-.049-1.168-.152-1.664-.392a4.2 4.2 0 0 1-1.866-1.784c-.267-.5-.375-1.046-.425-1.679l-.003-.033a2 2 0 0 1 .006-.498c.027-.16.083-.328.158-.471c.088-.169.21-.306.31-.422l.026-.03l.076-.086c.352-.403.648-.742.912-.996c.275-.265.57-.492.938-.62a2.6 2.6 0 0 1 1.698 0c.368.128.663.355.939.62c.264.254.56.593.912.996l.015.018h.002l2.65-2.62c.335-.33.617-.61.868-.82c.264-.22.541-.408.877-.514m1.107 1.43a1.1 1.1 0 0 0-.653 0c-.073.024-.177.075-.367.235c-.198.166-.437.401-.798.758l-2.634 2.603c-.607.6-1.612.567-2.176-.078c-.379-.434-.632-.723-.843-.926c-.206-.197-.317-.26-.393-.285a1.1 1.1 0 0 0-.71 0c-.075.026-.187.088-.392.285c-.212.204-.465.492-.844.926l-.054.063a5 5 0 0 0-.139.163l-.002.007l-.002.006v.01l.003.057l.008.105c.043.54.125.85.253 1.09c.26.486.677.888 1.2 1.142c.254.124.582.204 1.123.246c.549.043 1.251.043 2.245.043h2.807c.994 0 1.696 0 2.245-.043c.541-.043.869-.122 1.124-.246c.521-.254.94-.656 1.199-1.142c.228-.427.287-1.014.293-2.488a5 5 0 0 0-.003-.218l-.004-.009l-.016-.019a5 5 0 0 0-.147-.148l-1.158-1.144a15 15 0 0 0-.798-.758c-.19-.16-.294-.211-.367-.235" strokeWidth={0.5} stroke="currentColor"></path><path fill="currentColor" d="M11.567 3.25h2.866c.952 0 1.713 0 2.327.05c.63.052 1.172.16 1.67.413a4.25 4.25 0 0 1 1.857 1.858c.253.497.361 1.04.413 1.67c.05.613.05 1.374.05 2.326v2.866c0 .952 0 1.713-.05 2.327c-.052.63-.16 1.172-.413 1.67a4.25 4.25 0 0 1-1.857 1.857c-.498.253-1.04.361-1.67.413c-.614.05-1.375.05-2.327.05h-2.866c-.952 0-1.713 0-2.327-.05c-.63-.052-1.172-.16-1.67-.413a4.25 4.25 0 0 1-1.857-1.857c-.253-.498-.361-1.04-.413-1.67c-.05-.614-.05-1.375-.05-2.327V9.567c0-.952 0-1.713.05-2.327c.052-.63.16-1.172.413-1.67a4.25 4.25 0 0 1 1.858-1.857c.497-.253 1.04-.361 1.67-.413c.613-.05 1.374-.05 2.326-.05M9.362 4.795c-.537.044-.86.127-1.11.255A2.75 2.75 0 0 0 7.05 6.252c-.128.25-.21.573-.255 1.11c-.044.546-.045 1.246-.045 2.238v2.8c0 .992 0 1.692.045 2.238c.044.537.127.86.255 1.11a2.75 2.75 0 0 0 1.202 1.202c.25.128.573.21 1.11.255c.546.044 1.246.045 2.238.045h2.8c.992 0 1.692 0 2.238-.045c.537-.044.86-.127 1.11-.255a2.75 2.75 0 0 0 1.202-1.201c.128-.252.21-.574.255-1.111c.044-.546.045-1.245.045-2.238V9.6c0-.992 0-1.692-.045-2.238c-.044-.537-.127-.86-.255-1.11a2.75 2.75 0 0 0-1.2-1.202c-.252-.128-.574-.21-1.111-.255c-.546-.044-1.246-.045-2.238-.045h-2.8c-.992 0-1.692 0-2.238.045" strokeWidth={0.5} stroke="currentColor"></path><path fill="currentColor" d="M11.5 7.75a.75.75 0 1 0 0 1.5a.75.75 0 0 0 0-1.5m-2.25.75a2.25 2.25 0 1 1 4.5 0a2.25 2.25 0 0 1-4.5 0" strokeWidth={0.5} stroke="currentColor"></path><path fill="currentColor" d="M6.952 5.962a.75.75 0 0 1-.433.968A2.75 2.75 0 0 0 4.75 9.5V13c0 1.92.01 2.702.208 3.313a4.25 4.25 0 0 0 2.729 2.729c.611.199 1.393.208 3.313.208h3.5c1.16 0 2.154-.718 2.558-1.737a.75.75 0 0 1 1.394.553A4.25 4.25 0 0 1 14.5 20.75h-3.662c-1.706 0-2.747 0-3.615-.281a5.75 5.75 0 0 1-3.692-3.692c-.281-.868-.281-1.909-.281-3.615V9.5a4.25 4.25 0 0 1 2.734-3.971a.75.75 0 0 1 .968.433" strokeWidth={0.5} stroke="currentColor"></path></svg>);
}


export function MdiDollar(props: SVGProps<SVGSVGElement>) {
	return (<svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" {...props}><path fill="currentColor" d="M7 15h2c0 1.08 1.37 2 3 2s3-.92 3-2c0-1.1-1.04-1.5-3.24-2.03C9.64 12.44 7 11.78 7 9c0-1.79 1.47-3.31 3.5-3.82V3h3v2.18C15.53 5.69 17 7.21 17 9h-2c0-1.08-1.37-2-3-2s-3 .92-3 2c0 1.1 1.04 1.5 3.24 2.03C14.36 11.56 17 12.22 17 15c0 1.79-1.47 3.31-3.5 3.82V21h-3v-2.18C8.47 18.31 7 16.79 7 15" strokeWidth={0.5} stroke="currentColor"></path></svg>);
}


export function FontistoDollar(props: SVGProps<SVGSVGElement>) {
	return (<svg xmlns="http://www.w3.org/2000/svg" width={12} height={24} viewBox="0 0 12 24" {...props}><path fill="currentColor" d="m12.496 15.87l.001.092a5.08 5.08 0 0 1-1.337 3.441l.003-.004a5.74 5.74 0 0 1-3.432 1.824l-.031.004v2.36a.413.413 0 0 1-.413.413H7.27h.001h-1.807a.434.434 0 0 1-.429-.429v-2.344a8.4 8.4 0 0 1-1.766-.434l.059.019a8.2 8.2 0 0 1-2.37-1.254l.02.015a8 8 0 0 1-.629-.509l.007.006q-.167-.16-.234-.24a.407.407 0 0 1-.025-.55l-.001.001l1.379-1.808a.42.42 0 0 1 .307-.16h.001a.33.33 0 0 1 .32.121l.001.001l.026.026a6.97 6.97 0 0 0 3.208 1.666l.046.009c.298.068.64.107.991.107l.062.001c.691 0 1.331-.216 1.858-.584l-.011.007a1.88 1.88 0 0 0 .824-1.637v.004c0-.263-.075-.508-.204-.715l.003.006a2.5 2.5 0 0 0-.447-.559l-.001-.001a3.7 3.7 0 0 0-.761-.493l-.022-.01q-.536-.274-.88-.429t-1.071-.435q-.522-.214-.824-.335t-.824-.355t-.837-.415t-.757-.475a5 5 0 0 1-.721-.57l.001.001a8 8 0 0 1-.57-.64l-.013-.016a3.3 3.3 0 0 1-.467-.756l-.008-.021a5 5 0 0 1-.275-.854l-.007-.036a4.6 4.6 0 0 1-.114-1.022V7.85c0-1.25.501-2.384 1.314-3.21l-.001.001a6.1 6.1 0 0 1 3.379-1.789l.036-.005V.428c0-.117.049-.223.127-.298a.4.4 0 0 1 .298-.127h1.827c.228 0 .413.185.413.413v.017v-.001v2.357c.55.058 1.052.167 1.533.323l-.053-.015c.459.14.845.293 1.216.471l-.052-.022c.328.163.607.33.871.516l-.02-.014q.4.282.522.388t.201.187a.385.385 0 0 1 .066.51l.001-.001l-1.082 1.956a.36.36 0 0 1-.307.214h-.001a.42.42 0 0 1-.362-.094h.001q-.04-.04-.194-.16t-.522-.355a7 7 0 0 0-.741-.411l-.042-.018a5.6 5.6 0 0 0-.956-.339l-.042-.009a4.3 4.3 0 0 0-1.144-.154h-.001a3.46 3.46 0 0 0-2.088.584l.013-.008a1.8 1.8 0 0 0-.686 2.142l-.004-.012c.092.22.226.406.394.555l.002.001q.242.227.513.431l.016.011c.215.148.462.287.721.403l.03.012q.502.234.81.362t.938.368q.71.268 1.085.422t1.018.469a8 8 0 0 1 1.041.587l-.029-.018c.31.22.58.44.837.675l-.006-.006q.417.364.701.835l.009.016c.166.293.309.634.413.991l.009.034c.109.365.171.785.171 1.219v.042v-.002z" strokeWidth={0.5} stroke="currentColor"></path></svg>);
}

export default function ProiconsArrowTrending(props: SVGProps<SVGSVGElement>) {
	return (<svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" {...props}><path fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="m3.25 16.75l4.793-4.793a1 1 0 0 1 1.414 0l2.586 2.586a1 1 0 0 0 1.414 0L19.75 8.25l.56-.56m-5.56-.44h4.5c.414 0 .79.168 1.06.44m.44 5.56v-4.5c0-.414-.168-.79-.44-1.06"></path></svg>);
}


export function IconoirCoinsSwap(props: SVGProps<SVGSVGElement>) {
	return (<svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" {...props}><g fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5}><path d="M9.019 9A6.5 6.5 0 1 1 15 14.981"></path><path d="M8.5 22a6.5 6.5 0 1 1 0-13a6.5 6.5 0 0 1 0 13M22 17a3 3 0 0 1-3 3h-2m0 0l2-2m-2 2l2 2M2 7a3 3 0 0 1 3-3h2m0 0L5 6m2-2L5 2"></path></g></svg>);
}
...
export function StreamlineDollarCoinSolid(props: SVGProps<SVGSVGElement>) {
	return (<svg xmlns="http://www.w3.org/2000/svg" width={14} height={14} viewBox="0 0 14 14" {...props}><path fill="currentColor" fillRule="evenodd" d="M14 7A7 7 0 1 1 0 7a7 7 0 0 1 14 0M7.75 3.25a.75.75 0 0 0-1.5 0v.51a1.866 1.866 0 0 0-.2 3.678l1.474.323a.5.5 0 0 1-.107.989h-.834a.5.5 0 0 1-.471-.333a.75.75 0 0 0-1.415.5c.239.674.83 1.184 1.553 1.305v.528a.75.75 0 0 0 1.5 0v-.528a2.001 2.001 0 0 0 .094-3.927l-1.473-.322a.366.366 0 0 1 .078-.723h.968a.5.5 0 0 1 .471.333a.75.75 0 1 0 1.415-.5A2 2 0 0 0 7.75 3.778z" clipRule="evenodd" strokeWidth={0.5} stroke="currentColor"></path></svg>);
}

export function SolarDollarMinimalisticBoldDuotone(props: SVGProps<SVGSVGElement>) {
	return (<svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" {...props}><path fill="currentColor" fillRule="evenodd" d="M22 12c0 5.523-4.477 10-10 10S2 17.523 2 12S6.477 2 12 2s10 4.477 10 10" clipRule="evenodd" opacity={0.5} strokeWidth={0.5} stroke="currentColor"></path><path fill="currentColor" d="M12.75 6a.75.75 0 0 0-1.5 0v.317c-1.63.292-3 1.517-3 3.183c0 1.917 1.813 3.25 3.75 3.25c1.377 0 2.25.906 2.25 1.75s-.873 1.75-2.25 1.75c-1.376 0-2.25-.906-2.25-1.75a.75.75 0 0 0-1.5 0c0 1.666 1.37 2.891 3 3.183V18a.75.75 0 0 0 1.5 0v-.317c1.63-.292 3-1.517 3-3.183c0-1.917-1.813-3.25-3.75-3.25c-1.376 0-2.25-.906-2.25-1.75s.874-1.75 2.25-1.75c1.377 0 2.25.906 2.25 1.75a.75.75 0 0 0 1.5 0c0-1.666-1.37-2.891-3-3.183z" strokeWidth={0.5} stroke="currentColor"></path></svg>);
}


export  function CuidaNotificationBellOutline(props: SVGProps<SVGSVGElement>) {
	return (<svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" {...props}><g className="notification-bell-outline"><g fill="currentColor" className="Vector" strokeWidth={0.5} stroke="currentColor"><path fillRule="evenodd" d="M10.51 5.22c-.621.168-1.201.431-1.605.795c-1.103.995-1.552 2.343-1.552 4.773c0 1.732-.986 3.372-1.696 4.434c-.154.232-.202.453-.193.586c.004.06.018.088.024.098c.004.007.016.026.064.052c.692.37 1.736.64 2.943.811A26 26 0 0 0 12 17a1 1 0 1 1 0 2c-1.128 0-2.484-.065-3.786-.25c-1.282-.183-2.603-.493-3.605-1.028c-.737-.394-1.093-1.08-1.14-1.779c-.046-.659.177-1.31.525-1.831c.717-1.074 1.359-2.259 1.359-3.324c0-2.661.492-4.707 2.213-6.258c.725-.654 1.636-1.027 2.419-1.24A8 8 0 0 1 12 3a1 1 0 1 1 0 2c-.306 0-.876.052-1.49.22" clipRule="evenodd"></path><path fillRule="evenodd" d="M13.49 5.22c.621.168 1.201.431 1.605.795c1.103.995 1.552 2.343 1.552 4.773c0 1.732.986 3.372 1.696 4.434c.154.232.202.453.193.586a.2.2 0 0 1-.024.098c-.004.007-.016.026-.064.052c-.692.37-1.736.64-2.943.811A26 26 0 0 1 12 17a1 1 0 1 0 0 2c1.128 0 2.483-.065 3.786-.25c1.282-.183 2.603-.493 3.605-1.028c.737-.394 1.093-1.08 1.14-1.779c.046-.659-.177-1.31-.525-1.831c-.717-1.074-1.359-2.259-1.359-3.324c0-2.661-.492-4.707-2.213-6.258c-.725-.654-1.636-1.027-2.419-1.24A8 8 0 0 0 12 3a1 1 0 1 0 0 2c.306 0 .876.052 1.49.22" clipRule="evenodd"></path><path d="M14.647 3.68c0 .695-1.396.042-2.5.042s-2.5.653-2.5-.043c0-.695 1-1.679 2.5-1.679s2.5.984 2.5 1.68"></path><path fillRule="evenodd" d="M10 18a2 2 0 1 0 4 0h2a4 4 0 0 1-8 0z" clipRule="evenodd"></path></g></g></svg>);
}



export function HugeiconsAiBrain01(props: SVGProps<SVGSVGElement>) {
	return (<svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" {...props}><path fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M7 4.5a3 3 0 0 0-2.567 4.554a3.001 3.001 0 0 0 0 5.893M7 4.5a2.5 2.5 0 0 1 5 0v15a2.5 2.5 0 0 1-5 0a3 3 0 0 1-2.567-4.553M7 4.5c0 .818.393 1.544 1 2m-3.567 8.447A3 3 0 0 1 6 13.67m11 5.83a3 3 0 0 0 2.567-4.553a3.001 3.001 0 0 0 0-5.893M17 19.5a2.5 2.5 0 0 1-5 0v-15a2.5 2.5 0 0 1 5 0a3 3 0 0 1 2.567 4.554M17 19.5c0-.818-.393-1.544-1-2m3.567-8.446A3 3 0 0 1 18 10.329"></path></svg>);
}


export function SiDashboardCustomizeLine(props: SVGProps<SVGSVGElement>) {
	return (<svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" {...props}><path fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit={10} strokeWidth={1.5} d="M14 17h6m-3 3v-6M5.6 4h2.8A1.6 1.6 0 0 1 10 5.6v2.8A1.6 1.6 0 0 1 8.4 10H5.6A1.6 1.6 0 0 1 4 8.4V5.6A1.6 1.6 0 0 1 5.6 4m0 10h2.8a1.6 1.6 0 0 1 1.6 1.6v2.8A1.6 1.6 0 0 1 8.4 20H5.6A1.6 1.6 0 0 1 4 18.4v-2.8A1.6 1.6 0 0 1 5.6 14m10-10h2.8A1.6 1.6 0 0 1 20 5.6v2.8a1.6 1.6 0 0 1-1.6 1.6h-2.8A1.6 1.6 0 0 1 14 8.4V5.6A1.6 1.6 0 0 1 15.6 4"></path></svg>);
}
...
export function TablerLayoutSidebarLeftCollapse(props: SVGProps<SVGSVGElement>) {
	return (<svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" {...props}><g fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth={2}><path d="M4 6a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2zm5-2v16"></path><path d="m15 10l-2 2l2 2"></path></g></svg>);
}


export function PhUser(props: SVGProps<SVGSVGElement>) {
	return (<svg xmlns="http://www.w3.org/2000/svg" width={256} height={256} viewBox="0 0 256 256" {...props}><path fill="currentColor" d="M230.92 212c-15.23-26.33-38.7-45.21-66.09-54.16a72 72 0 1 0-73.66 0c-27.39 8.94-50.86 27.82-66.09 54.16a8 8 0 1 0 13.85 8c18.84-32.56 52.14-52 89.07-52s70.23 19.44 89.07 52a8 8 0 1 0 13.85-8M72 96a56 56 0 1 1 56 56a56.06 56.06 0 0 1-56-56" strokeWidth={6.5} stroke="currentColor"></path></svg>);
}



export function SystemUiconsWindowCollapseRight(props: SVGProps<SVGSVGElement>) {
	return (<svg xmlns="http://www.w3.org/2000/svg" width={21} height={21} viewBox="0 0 21 21" {...props}><g fill="none" fillRule="evenodd" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth={1}><path d="M3.5 15.5v-10a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2h-10a2 2 0 0 1-2-2"></path><path fill="currentColor" d="M15.5 15.5v-10a2 2 0 0 0-2-2h2c1 0 2 .895 2 2v10c0 1.105-1 2-2 2h-2a2 2 0 0 0 2-2"></path><path d="m10.5 13.5l3-3l-3-3m3 3h-8"></path></g></svg>);
}


export function SystemUiconsWindowCollapseLeft(props: SVGProps<SVGSVGElement>) {
	return (<svg xmlns="http://www.w3.org/2000/svg" width={21} height={21} viewBox="0 0 21 21" {...props}><g fill="none" fillRule="evenodd" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth={1}><path d="M3.5 15.5v-10a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2h-10a2 2 0 0 1-2-2"></path><path fill="currentColor" d="M5.5 15.5v-10a2 2 0 0 1 2-2h-2c-1 0-2 .895-2 2v10c0 1.105 1 2 2 2h2a2 2 0 0 1-2-2"></path><path d="m10.5 13.5l-3-3l3-3m5 3h-8"></path></g></svg>);
}


export function SolarLoginBoldDuotone(props: SVGProps<SVGSVGElement>) {
	return (<svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" {...props}><path fill="currentColor" fillRule="evenodd" d="M10.47 8.47a.75.75 0 0 0 0 1.06l1.72 1.72H4a.75.75 0 0 0 0 1.5h8.19l-1.72 1.72a.75.75 0 1 0 1.06 1.06l3-3a.75.75 0 0 0 0-1.06l-3-3a.75.75 0 0 0-1.06 0" clipRule="evenodd" strokeWidth={0.5} stroke="currentColor"></path><path fill="currentColor" d="M12 20a8 8 0 1 0 0-16z" opacity={0.5} strokeWidth={0.5} stroke="currentColor"></path></svg>);
}
...
export function HugeiconsBlockchain06(props: SVGProps<SVGSVGElement>) {
	return (<svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" {...props}><path fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M5.5 10c.122 0 .236-.057.463-.17l1.825-.908C8.596 8.519 9 8.318 9 8V4m-3.5 6c-.122 0-.236-.057-.463-.17l-1.825-.908C2.404 8.519 2 8.318 2 8V4m3.5 6V6M9 4c0-.318-.404-.52-1.212-.922L5.963 2.17C5.736 2.057 5.623 2 5.5 2c-.122 0-.236.057-.463.17l-1.825.908C2.404 3.481 2 3.682 2 4m7 0c0 .318-.404.52-1.212.922l-1.825.908c-.227.113-.34.17-.463.17M2 4c0 .318.404.52 1.212.922l1.825.908c.227.113.34.17.463.17m13 4c.122 0 .236-.057.463-.17l1.825-.908C21.596 8.519 22 8.318 22 8V4m-3.5 6c-.122 0-.236-.057-.463-.17l-1.825-.908C15.404 8.519 15 8.318 15 8V4m3.5 6V6M22 4c0-.318-.404-.52-1.212-.922l-1.825-.908c-.227-.113-.34-.17-.463-.17c-.122 0-.236.057-.463.17l-1.825.908C15.404 3.481 15 3.682 15 4m7 0c0 .318-.404.52-1.212.922l-1.825.908c-.227.113-.34.17-.463.17M15 4c0 .318.404.52 1.212.922l1.825.908c.227.113.34.17.463.17m-7 0h1M2 12v3.5c0 1.404 0 2.107.337 2.611a2 2 0 0 0 .552.552C3.393 19 4.096 19 5.5 19M22 12v3.5c0 1.404 0 2.107-.337 2.611a2 2 0 0 1-.552.552C20.607 19 19.904 19 18.5 19M12 22c.122 0 .236-.056.463-.17l1.825-.908c.808-.402 1.212-.604 1.212-.922v-4M12 22c-.122 0-.236-.056-.463-.17l-1.825-.908C8.904 20.52 8.5 20.318 8.5 20v-4m3.5 6v-4m3.5-2c0-.318-.404-.52-1.212-.922l-1.825-.908c-.227-.114-.34-.17-.463-.17c-.122 0-.236.056-.463.17l-1.825.908c-.808.402-1.212.604-1.212.922m7 0c0 .318-.404.52-1.212.922l-1.825.908c-.227.114-.34.17-.463.17m-3.5-2c0 .318.404.52 1.212.922l1.825.908c.227.114.34.17.463.17"></path></svg>);
}