...
export const TokenRowSkeleton = () => (
  <div className="flex items-center gap-3 p-4 min-h-[64px] animate-pulse">
    <div className="w-12 h-12 bg-default-300 rounded-xl" />
    <div className="flex-1 min-w-0 space-y-2">
      <div className="h-4 bg-default-300 rounded w-32" />
      <div className="h-3 bg-default-200 rounded w-20" />
    </div>
    <div className="hidden md:block w-20 h-2 bg-default-200 rounded" />
    <div className="text-right space-y-2">
      <div className="h-4 bg-default-300 rounded w-24" />
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-2 mb-1">
              <h4 className="font-semibold truncate flex items-center gap-2">
                <span className={clsx("text-sm", isHovered && "text-primary")}>
                  {token.symbol}
                </span>
                ...
                {showPerformanceBadge && (
                  <Tooltip
                    content={`${token.daychange >= 10 ? "Hot" : "Volatile"} token`}
                  >
                    <div
                      className={clsx(
