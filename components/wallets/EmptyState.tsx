...
import {
  FluentCubeSync20Regular,
  SolarShieldCheckBoldDuotone,
  SolarWalletBoldDuotone,
  StreamlineFreehandHierarchyWeb,
} from "../icons/icons";
    ...
    <div className="text-center py-4">
      <div className="max-w-md mx-auto">
        ...
        <p className="text-gray-600 text-sm dark:text-gray-400 mb-8 leading-relaxed">
          Add your first cryptocurrency wallet to start tracking your portfolio
          across all supported chains. Monitor your assets, analyze performance,
          and stay on top of your investments.
        </p>
        ...
        <p className="text-xs text-gray-500 dark:text-gray-400 mt-6">
          We support Ethereum, Polygon, Arbitrum, Optimism, Base, BSC, and 24+
          more
        </p>
      </div>
    </div>
